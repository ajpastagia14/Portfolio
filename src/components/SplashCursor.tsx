// @ts-nocheck
// Ported as-is from the WebGL fluid-cursor effect used on the previous
// portfolio (reactbits-style SplashCursor). Left untyped/unmodified since
// it's a self-contained visual effect with heavy low-level WebGL code that
// TypeScript's closure narrowing can't follow cleanly.
'use client';
